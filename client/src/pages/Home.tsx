    ...
    <SeatingProvider>
      <div className="h-screen flex flex-col bg-[#f8f5ef] overflow-hidden">
        ...
        <header className="shrink-0 border-b border-[#e0d9d0] bg-[#f8f5ef]">
          <div className="px-3 md:px-6 py-2 md:py-4 flex items-center md:items-end justify-between gap-2 md:gap-4">
            {/* Left: event name + label */}
            <div className="flex items-center md:items-end gap-2 md:gap-6 min-w-0">
              <div className="min-w-0">
                <p className="editorial-label text-[#b0a89e] mb-0 md:mb-1 text-[9px] md:text-xs">Layout Corporativo</p>
                <h1 className="editorial-headline text-xl sm:text-3xl md:text-5xl text-[#1c1917] leading-none truncate">
                  {event.name}
                </h1>
              </div>
